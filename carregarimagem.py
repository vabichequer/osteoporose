...
csv_file = open("resultados.csv", 'wb')
writer = csv.writer(csv_file)
writer.writerow(["PCA", "VC - LBFGS", "Media - LBFGS", "VC - SGD", "Media - SGD", "VC - ADAM", "Media - ADAM"])
...
for i in range(1, 101):
	...
	print("#\n#----------------------------------------------------------\n#")
	[cross_val_lbfgs, mean_lbfgs] = avaliar("lbfgs", imagensTreinoPCA, targetTreino, imagensTestePCA, targetTeste)
	print("#\n#----------------------------------------------------------\n#")
	[cross_val_sgd, mean_sgd] = avaliar("sgd", imagensTreinoPCA, targetTreino, imagensTestePCA, targetTeste)
	print("#\n#----------------------------------------------------------\n#")
	[cross_val_adam, mean_adam] = avaliar("adam", imagensTreinoPCA, targetTreino, imagensTestePCA, targetTeste)
	writer.writerow([i, cross_val_lbfgs, mean_lbfgs, cross_val_sgd, mean_sgd, cross_val_adam, mean_adam])
	print("#\n###########################################################\n")
